            ...
            <div class="head_wrap">
                ...
                <div class="left_menu">
                    <ul>
                        ...
                        <li id="menu-item-951" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-365 current_page_item menu-item-951"><a href="./construct_files/construct.html">Конструктор пиццы</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="main">
            <div class="content_wrap constructor">
                ...
                <div class="c_check">
                    ...
                    <a href="" id="order_construct" construct_id="1"><img src="img/order_c.png">
                    </a>
                ...
                <div class="korzh">
                    ...
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="734"><img width="552" height="552" src="img/salyami1.png" class="attachment-post-thumbnail wp-post-image" alt="салями">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1300;" ingr_id="731"><img width="552" height="552" src="img/Pengasius.png" class="attachment-post-thumbnail wp-post-image" alt="Пенгасиус">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1300;" ingr_id="729"><img width="552" height="552" src="img/Morskoy-kokteyl.png" class="attachment-post-thumbnail wp-post-image" alt="Морской-коктейль">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="727"><img width="552" height="552" src="img/kopchenaya-kuritsa.png" class="attachment-post-thumbnail wp-post-image" alt="копченая-курица">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1300;" ingr_id="722"><img width="552" height="552" src="img/Krevetki.png" class="attachment-post-thumbnail wp-post-image" alt="Креветки">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:0;" ingr_id="720"></div>
                    <div class="ingr_one" style="opacity:0; z-index:1600;" ingr_id="715"><img width="552" height="552" src="img/Bazilik.png" class="attachment-post-thumbnail wp-post-image" alt="Базилик">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1203;" ingr_id="714"><img width="552" height="552" src="img/Bekon.png" class="attachment-post-thumbnail wp-post-image" alt="Бекон">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1000;" ingr_id="713"><img width="552" height="552" src="img/Belyiy-slivochnyiy.png" class="attachment-post-thumbnail wp-post-image" alt="Белый-сливочный">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="712"><img width="552" height="552" src="img/bolgarskiy.png" class="attachment-post-thumbnail wp-post-image" alt="болгарский">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="711"><img width="552" height="552" src="img/brokkoli.png" class="attachment-post-thumbnail wp-post-image" alt="брокколи">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="710"><img width="552" height="552" src="img/Vetchina.png" class="attachment-post-thumbnail wp-post-image" alt="Ветчина">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1600;" ingr_id="709"><img width="552" height="552" src="img/Vostochnyie-pripravyi.png" class="attachment-post-thumbnail wp-post-image" alt="Восточные-приправы">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="708"><img width="552" height="552" src="img/Govyadina1.png" class="attachment-post-thumbnail wp-post-image" alt="Говядина">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1600;" ingr_id="707"><img width="552" height="552" src="img/Zelen.png" class="attachment-post-thumbnail wp-post-image" alt="Зелень">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="706"><img width="552" height="552" src="img/Zelenyiy-luk1.png" class="attachment-post-thumbnail wp-post-image" alt="Зеленый-лук">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1300;" ingr_id="705"><img width="552" height="552" src="img/Kalmar.png" class="attachment-post-thumbnail wp-post-image" alt="Кальмар">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="704"><img width="552" height="552" src="img/Karbonat.png" class="attachment-post-thumbnail wp-post-image" alt="Карбонат">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="703"><img width="552" height="552" src="img/kukuruza.png" class="attachment-post-thumbnail wp-post-image" alt="кукуруза">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="702"><img width="552" height="552" src="img/Kuritsa1.png" class="attachment-post-thumbnail wp-post-image" alt="Курица">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="700"><img width="552" height="552" src="img/Luk-repchatyiy.png" class="attachment-post-thumbnail wp-post-image" alt="Лук-репчатый">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="699"><img width="552" height="552" src="img/marinovannyie.png" class="attachment-post-thumbnail wp-post-image" alt="маринованные">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="698"><img width="552" height="552" src="img/maslinyi.png" class="attachment-post-thumbnail wp-post-image" alt="маслины">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="696"><img width="552" height="552" src="img/olivki.png" class="attachment-post-thumbnail wp-post-image" alt="оливки">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1400;" ingr_id="695"><img width="552" height="552" src="img/Opyata.png" class="attachment-post-thumbnail wp-post-image" alt="Опята">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="694"><img width="552" height="552" src="img/ohotnichi1.png" class="attachment-post-thumbnail wp-post-image" alt="охотничьи">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="693"><img width="552" height="552" src="img/perets-chili.png" class="attachment-post-thumbnail wp-post-image" alt="перец-чили">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="692"><img width="552" height="552" src="img/Pomidoryi.png" class="attachment-post-thumbnail wp-post-image" alt="Помидоры">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="690"><img width="552" height="552" src="img/salyami.png" class="attachment-post-thumbnail wp-post-image" alt="салями">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="689"><img width="552" height="552" src="img/Svinina2.png" class="attachment-post-thumbnail wp-post-image" alt="Свинина">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1300;" ingr_id="688"><img width="552" height="552" src="img/semga.png" class="attachment-post-thumbnail wp-post-image" alt="семга">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1000;" ingr_id="687"><img width="552" height="552" src="img/Slivochno-gorchichnyiy.png" class="attachment-post-thumbnail wp-post-image" alt="Сливочно-горчичный">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1000;" ingr_id="686"><img width="552" height="552" src="img/Sous-Master.png" class="attachment-post-thumbnail wp-post-image" alt="Соус-Мастер">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1000;" ingr_id="685"><img width="552" height="552" src="img/Sous-Master-ostryiy.png" class="attachment-post-thumbnail wp-post-image" alt="Соус-Мастер-острый">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1100;" ingr_id="684"><img width="552" height="552" src="img/Syir-Gauda.png" class="attachment-post-thumbnail wp-post-image" alt="Сыр-Гауда">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1100;" ingr_id="683"><img width="552" height="552" src="img/Syir-Golladnskiy.png" class="attachment-post-thumbnail wp-post-image" alt="Сыр-Голладнский">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1100;" ingr_id="681"><img width="552" height="552" src="img/Syir-motsarela.png" class="attachment-post-thumbnail wp-post-image" alt="Сыр-моцарела">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1100;" ingr_id="680"><img width="552" height="552" src="img/Syir-Parmezan.png" class="attachment-post-thumbnail wp-post-image" alt="Сыр-Пармезан">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1600;" ingr_id="679"><img width="552" height="552" src="img/CHernyiy-perets.png" class="attachment-post-thumbnail wp-post-image" alt="Черный-перец">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1500;" ingr_id="677"><img width="552" height="552" src="img/CHerri.png" class="attachment-post-thumbnail wp-post-image" alt="Черри">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1400;" ingr_id="676"><img width="552" height="552" src="img/SHampinonyi.png" class="attachment-post-thumbnail wp-post-image" alt="Шампиньоны">
                    </div>
                    <div class="ingr_one" style="opacity:0; z-index:1200;" ingr_id="673"><img width="552" height="552" src="img/YAzyik2.png" class="attachment-post-thumbnail wp-post-image" alt="Язык">
                    </div>
                </div>
