...
<?php get_header(); ?>
    ...
    <div id="footer">
        <div class="footer_wrap">
            ...
            <div class="footmenu">
                <ul>
                    <li id="menu-item-424" class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-424"><a href="./category_files/category.html">Пицца</a>
                    </li>
