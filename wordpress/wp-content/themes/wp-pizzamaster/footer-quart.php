...
<div class="bottom_blocks">
    ...
    <div class="work">
        ...
        <ul class="social">
            <li>
                <noindex><a href="http://vk.com/pizza700700" target="_blank" rel="nofollow"><img src="<?php echo get_template_directory_uri(); ?>/img/vk.jpg"></a>
                </noindex>
            </li>
            <!--
    ...
    <div class="footer_wrap">
        ...
        <div class="footmenu">
            <ul>
                ...
                <li id="menu-item-426" class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-426"><a href="./quart_files/quart.html">Напитки</a>
                </li>
...
<div class="popup cartform" data-noreg="1" style="display: block;">
    ...
    <div class="full_cart_data allcart" style="display: block;">
        ...
        <div class="big_cart_wrapper">
            <div class="order_line" discount="0" discount2="" cat="drinks">
                <div class="order_ico tablecell"><a href="http://700-700.ru/voda-bonakva-1209/"><img width="76" height="104" src="<?php echo get_template_directory_uri(); ?>/img/Voda_Bonakva-1l_logo-76x104.jpg" class="attachment-menu_76" alt="Вода_Бонаква 1л_logo"></a>
                </div>
                ...
                <div class="tabledel tablecell"><span class="delthis" del_id="1209"><img src="<?php echo get_template_directory_uri(); ?>/img/delete.png"></span>
                </div>
            </div>
        ...
        <div class="order_total">
            ...
            <div class="order_total_price">
                ...
                Итого: <span class="red"><span class="total">80</span> р</span>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="order_contacts">
            ...
            <div class="order_formline" style="display:none;">
                <div class="order_formcell">
                    <label class="cardcell">
                        <input name="paymethod" type="radio" id="order_cash">Я хочу оплачить заказ наличными</label>
                    <label class="cardcell">
                        <input name="paymethod" type="radio" id="order_cardpay">Я хочу оплатить заказ пластиковой картой</label>
                    <label class="cardcell">
                        <input name="paymethod" type="radio" id="order_online" checked="checked">Я хочу оплатить заказ онлайн (Robokassa)</label>
                </div>
            </div>
    ...
    <div class="itempopup_wrap">
        <div class="single_pizza">
            ...
            <div class="single_rightside">
                ...
                <h5>Описание</h5> Яблочный сок
                <div class="weight">
                    <ul class="variants">
                        <li class="current">1 л – <span>80 р</span>
                        </li>
                    </ul>
                    ...
                    <div class="calories">
                        ...
                        <ul>
                            <li>
                                <label>Белки</label><span>0.5 г</span>
                            </li>
                            <li>
                                <label>Жиры</label><span>0.2 г</span>
                            </li>
                            <li>
                                <label>Углеводы</label><span>11.7 г</span>
                            </li>
                            <li>
                                <label>Калории</label><span>46.8 Ккал</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="login_box">
            ...
            <form name="loginform" id="loginform" action="http://700-700.ru/login/" method="post">
                ...
                <div class="formline">
                    ...
                    <input type="hidden" name="_wp_http_referer" value="/drinks/"> </div>
